        ...
        <div>
          <div className="title_card">
            <img
              ...
              alt="Foto de perfil"
            ></img>
            <Link to={`/studies/${data.study_id}`} style={{ all: "unset", cursor: "pointer" }}>
          ...
          <div className="data_card">
            <div className="info_card">
              ...
              <p className="info_card_p">{data.type_of_institution.charAt(0).toUpperCase() + data.type_of_institution.slice(1).toLowerCase()}</p>
              <p className="info_card_p">{data.modality.charAt(0).toUpperCase() + data.modality.slice(1).toLowerCase()}</p>
            </div>
            <div className="iconos_card">
              ...
              >
                <g>
                  <path d="m85.1 100c-.5 0-1.6 0-2.1-.5h-.5l-32.5-13.6-32.4 13.6c-2.1 1-4.7.5-6.3-.5s-2.6-3.1-2.6-5.2v-73.3c0-11.5 8.9-20.4 20.4-20.4h41.9c11.5 0 20.4 8.9 20.4 20.4v73.3c0 2.1-1 4.2-2.6 5.2-1.1.5-2.7 1-3.7 1zm-56-90c-5.2 0-9.9 4.7-9.9 9.9v67.5l30.8-13 30.9 13.1v-67.6c0-5.2-4.7-9.9-9.9-9.9z" />
                </g>
              </svg>
            </div>
          </div>
